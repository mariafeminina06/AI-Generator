...
function generateTravel(event) {
  ...
  let prompt = `User Instruction: Please provide list of popular tourist attractions, popular restaurants, local delicacies, modes of transport, local currency and popular hotels in the area while visiting ${destination.value}.`;
  let context =
